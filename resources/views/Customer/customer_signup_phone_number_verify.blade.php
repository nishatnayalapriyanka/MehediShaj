...
<body>
	<form method="post" action="/customer_signup_phone_number_verify" class="form">
        @csrf 
		...
		<div class="input_box">
	        ...
	        <input class="input" type="text" name="customer_signup_phone"
            placeholder="Enter Phone Number" value="{{old('customer_signup_phone')}}">
		</div>
        <div class="errorMsg">   
            @error('customer_signup_phone')
