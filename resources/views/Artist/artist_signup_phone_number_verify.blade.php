...
<body>
	<form method="post" action="/artist_signup_phone_number_verify" class="form">
        @csrf 
		...
		<div class="input_box">
	        ...
	        <input class="input" type="text" name="artist_signup_phone"
            placeholder="Enter Phone Number" value="{{old('artist_signup_phone')}}">
		</div>
        <div class="errorMsg">   
            @error('artist_signup_phone')
